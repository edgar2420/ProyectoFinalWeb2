...
import EditarActor from './pages/actores/editarActores.jsx';
import ListaActoresEdit from './pages/actores/ListaActoresEdit.jsx';
import ListaDirectoresEdit from './pages/directores/ListaDirectoresEdit.jsx';
import EditDirectores from './pages/directores/EditDirectores.jsx';
  ...
  <StrictMode>
    <Router>
      ...
      <Routes>
        ...
        <Route path="/editar-actores/:id" element={< EditarActor />} />
        ...
        <Route path="/directores/edit" element={<ListaDirectoresEdit />} />
        <Route path="/editar-director/:id" element={<EditDirectores />} />
        <Route path="/directores/create" element={<CrearDirector />} />
        <Route path="/actores" element={<ListaActores />} />
        <Route path="/actores/edit" element={<ListaActoresEdit />} />
